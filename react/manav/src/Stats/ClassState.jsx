    ...
    render() {
        ...
        return (
            <div>
                ...
                <button onClick={() => this.setState({ name: "Inayat Parmar" })}>Change name</button>
                <button onClick={() => this.setState({ name: "Uttam Barvar" })}>Change name2</button>
                <button onClick={() => this.setState({ name: "Manav Prajapati" })}>Old Name</button>
                ...
                <button onClick={() => this.setState({ count: this.state.count + 2 })}>increment with 2</button>
