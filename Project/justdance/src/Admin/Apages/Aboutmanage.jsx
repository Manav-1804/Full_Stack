    ...
    return (
        <div>
            ...
            <div className="container">
                <h1 className='text-center'>Hello This Is Our Team Manage Page</h1>
                            ...
                            <div className="modal-body">
                                <div className="card" style={{ width: "100%" }}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <h5 className="card-title">{singlepro.role}</h5>
