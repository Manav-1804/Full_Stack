...
function Eventmanage() {
    ...
    return (
        <div>
            <Aheader />
            <Anavbar title="Event Manage" name="Event Manage" />
            <Helmet>
            ...
            <div className="container">
                <h1 className='text-center'>Hello This Is Our Event Manage Page</h1>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h1 className="modal-title fs-5" id="staticBackdropLabel">Event Manage</h1>
                            ...
                            <div className="modal-body">
                                <div className="card" style={{ width: "100%" }}>
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title">{singlepro.time}</h5>
                                        <h5 className="card-title">{singlepro.city}</h5>
